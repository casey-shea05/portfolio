...
<html lang="en">
  ...
  <body onload="initialise();">
    ...
    <div class="container">
        ...
        <p>We have drugs, get your drugs here, also a flag:  
        ...
        ?> </span> 
        <br/> <small class="muted">And a <em>hit</em> here and there.</small></p>
        <?php else: ?>
        <h1>Sensible Furniture.</h1>
        <p>Or as sensible as furniture can be! We have tables, beds and what not.</p>
        <div class="row">
