<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") {
	$sql = "SELECT id, name, full, password, is_dealer FROM users WHERE password='" . 
	      SQLite3::escapeString($_POST['password']) . "' AND name='" . $_POST['username'] . "';";

  $result = $website_db->querySingle($sql, true);
  if($result === false)
